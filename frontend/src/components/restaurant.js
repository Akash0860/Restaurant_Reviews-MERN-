      ...
      {restaurant ? (
        <div>
          ...
          <p>
            ...
            <strong>Address: </strong>{restaurant.address && restaurant.address.building} {restaurant.address && restaurant.address.street}{restaurant.address && restaurant.address.zipcode}
